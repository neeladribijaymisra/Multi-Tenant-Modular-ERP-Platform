...
export const roleContent = {
  ...
  teacher: {
    welcome: "Manage students, subjects, classes, timings, advisories, and progress from one teacher workspace.",
    modules: ["Student Control", "Subject Lists", "Class Timings", "Advisories"],
    highlights: [
    ...
    actions: ["Add student", "Create class slot", "Publish advisory"],
  ...
  academic: {
    welcome: "Coordinate curriculum planning, timetables, approvals, and records through one academic office login.",
    modules: ["Teacher Accounts", "Curriculum Planning", "Approvals", "Records"],
    highlights: [
    ...
    actions: ["Add teacher", "Generate password", "Approve revision"],
