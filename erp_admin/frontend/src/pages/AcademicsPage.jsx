...
import EnrollmentWizardDialog from '../components/academics/EnrollmentWizardDialog';
  ...
  return (
    <div className="finance-page">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 animate-fadeInUp">
        ...
        <Button variant="contained" size="small" startIcon={<Add />} onClick={() => setEnrollmentOpen(true)}>
          Add New Student
        </Button>
      </div>
      ...
      <EnrollmentWizardDialog open={enrollmentOpen} onClose={() => setEnrollmentOpen(false)} onSuccess={fetchAll} />
