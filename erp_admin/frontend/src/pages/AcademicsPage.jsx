...
import AcademicsAddStudentDialog from '../components/academics/AcademicsAddStudentDialog';
...
export default function AcademicsPage() {
  ...
  const addStudentButtonSx = {
    ...
    color: '#ffffff',
    background: 'linear-gradient(135deg, #0f274f 0%, #15366c 52%, #315da8 100%)',
    boxShadow: '0 18px 34px rgba(15, 39, 79, 0.22)',
    border: '1px solid rgba(255,255,255,0.12)',
    '&:hover': {
      background: 'linear-gradient(135deg, #0c2142 0%, #112d59 52%, #284c8d 100%)',
      boxShadow: '0 20px 40px rgba(15, 39, 79, 0.28)',
    },
  };
    ...
    <div className="finance-page">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 animate-fadeInUp">
        ...
        <Button
          ...
          className="group relative overflow-hidden px-4 py-2.5 shadow-none"
          sx={addStudentButtonSx}
        >
          <span className="absolute inset-0 bg-[linear-gradient(120deg,transparent_0%,rgba(255,255,255,0.18)_45%,transparent_100%)] translate-x-[-120%] transition-transform duration-700 group-hover:translate-x-[120%]" />
          <span className="relative flex items-center gap-2">
            Add New Student
            <span className="rounded-full bg-white/14 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.16em] text-white/90">
              Quick
            </span>
          </span>
        </Button>
      ...
      <AcademicsAddStudentDialog open={addStudentOpen} onClose={() => setAddStudentOpen(false)} onSuccess={fetchAll} />
